...
const SEED_LISTINGS: Listing[] = [
  {
    ...
    source: 'EstateSales.net', source_url: null,
  ...
  },
  {
    ...
    source: 'Craigslist', source_url: null,
  ...
  },
  {
    ...
    source: 'MaxSold', source_url: null,
        ...
        <div style={{ maxWidth: 860, margin: '0 auto', padding: '3rem 2rem' }}>
          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{ fontSize: '0.75rem', color: 'var(--ink-faint)' }}>{listing.neighborhood}, {listing.city}</div>
            </div>
